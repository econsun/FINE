...
\definecolor{brownc}{rgb}{1.00,0.67,0.22}

\newcounter{graph}[chapter]
\renewcommand{\thegraph}{\arabic{chapter}-\arabic{graph}}
\newtcbtheorem[use counter=graph, number within = chapter]{graph}{图}{
    enhanced,
    sharp corners,
    attach boxed title to top left={
        yshifttext=-1mm
...
\definecolor{browna}{rgb}{0.76,0.72,0.65}
\newtcbtheorem[no counter]{derive}{数学推导}{
    enhanced,
    sharp corners,
    attach boxed title to top left={
        yshifttext=-1mm
...
\definecolor{browna}{rgb}{0.76,0.72,0.65}
\newtcbtheorem[no counter]{faq}{问题}{
    enhanced,
    sharp corners,
    attach boxed title to top left={
        yshifttext=-1mm
