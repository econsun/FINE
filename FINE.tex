...
% 设置 enumerate
\usepackage{enumitem}
\setenumerate[1]{label=\textendash,itemsep=2pt,parsep=0\parskip,topsep=0pt}
\setitemize[1]{itemsep=2pt,partopsep=0pt,parsep=\parskip,topsep=5pt}
\setdescription{itemsep=2pt,partopsep=0pt,parsep=\parskip,topsep=5pt}
...
\definecolor{brownb}{rgb}{0.76,0.72,0.65}
\newtcbtheorem[no counter]{experience}{经验}{
    enhanced,
    sharp corners,
    attach boxed title to top left={
        yshifttext=-1mm
...
\title{A Fantastic Intermediate Note on Economics\\(FINE, Wish Your Life Be Fine)}
\author{Paul Sun}
\date{\zhtoday}
\maketitle
